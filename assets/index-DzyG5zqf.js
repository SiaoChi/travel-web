 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,z){var L=N.length;N.push(z);e:for(;0<L;){var B=L-1>>>1,U=N[B];if(0<i(U,z))N[B]=z,N[L]=U,L=B;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var z=N[0],L=N.pop();if(L!==z){N[0]=L;e:for(var B=0,U=N.length,Jt=U>>>1;B<Jt;){var We=2*(B+1)-1,yt=N[We],_e=We+1,lt=N[_e];if(0>i(yt,L))_e<U&&0>i(lt,yt)?(N[B]=lt,N[_e]=L,B=_e):(N[B]=yt,N[We]=L,B=We);else if(_e<U&&0>i(lt,L))N[B]=lt,N[_e]=L,B=_e;else break e}}return z}function i(N,z){var L=N.sortIndex-z.sortIndex;return L!==0?L:N.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,a=o.now();e.unstable_now=function(){return o.now()-a}}var u=[],c=[],m=1,h=null,g=3,y=!1,w=!1,S=!1,_=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(N){for(var z=n(c);z!==null;){if(z.callback===null)r(c);else if(z.startTime<=N)r(c),z.sortIndex=z.expirationTime,t(u,z);else break;z=n(c)}}function v(N){if(S=!1,p(N),!w)if(n(u)!==null)w=!0,or(E);else{var z=n(c);z!==null&&Gt(v,z.startTime-N)}}function E(N,z){w=!1,S&&(S=!1,f($),$=-1),y=!0;var L=g;try{for(p(z),h=n(u);h!==null&&(!(h.expirationTime>z)||N&&!Ce());){var B=h.callback;if(typeof B=="function"){h.callback=null,g=h.priorityLevel;var U=B(h.expirationTime<=z);z=e.unstable_now(),typeof U=="function"?h.callback=U:h===n(u)&&r(u),p(z)}else r(u);h=n(u)}if(h!==null)var Jt=!0;else{var We=n(c);We!==null&&Gt(v,We.startTime-z),Jt=!1}return Jt}finally{h=null,g=L,y=!1}}var C=!1,j=null,$=-1,W=5,R=-1;function Ce(){return!(e.unstable_now()-R<W)}function Yt(){if(j!==null){var N=e.unstable_now();R=N;var z=!0;try{z=j(!0,N)}finally{z?Kt():(C=!1,j=null)}}else C=!1}var Kt;if(typeof d=="function")Kt=function(){d(Yt)};else if(typeof MessageChannel<"u"){var li=new MessageChannel,Yl=li.port2;li.port1.onmessage=Yt,Kt=function(){Yl.postMessage(null)}}else Kt=function(){_(Yt,0)};function or(N){j=N,C||(C=!0,Kt())}function Gt(N,z){$=_(function(){N(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){w||y||(w=!0,or(E))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(N){switch(g){case 1:case 2:case 3:var z=3;break;default:z=g}var L=g;g=z;try{return N()}finally{g=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,z){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var L=g;g=N;try{return z()}finally{g=L}},e.unstable_scheduleCallback=function(N,z,L){var B=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?B+L:B):L=B,N){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=L+U,N={id:m++,callback:z,priorityLevel:N,startTime:L,expirationTime:U,sortIndex:-1},L>B?(N.sortIndex=L,t(c,N),n(u)===null&&N===n(c)&&(S?(f($),$=-1):S=!0,Gt(v,L-B))):(N.sortIndex=U,t(u,N),w||y||(w=!0,or(E))),N},e.unstable_shouldYield=Ce,e.unstable_wrapCallback=function(N){var z=g;return function(){var L=g;g=z;try{return N.apply(this,arguments)}finally{g=L}}}})(Lc);zc.exports=Lc;var Xp=zc.exports;/**
 * @license React
...
`,y1=x.div`
  position: relative;
  right: 50px;
`,Ke=({color:e="yellow",hoverBgColor:t,children:n,onClick:r,icon:i,width:l,height:o})=>s.jsxs(v1,{$color:e,$hoverBgColor:t,onClick:r,$width:l,$height:o,children:[s.jsx(vp,{$color:e,$width:l,$height:o}),s.jsx(yp,{$color:e,$isAccordion:!!i,$width:l,$height:o,children:s.jsx("div",{style:{zIndex:5},children:n})}),i&&s.jsx(y1,{children:i})]});Ke.propTypes={color:dt.string,children:dt.node.isRequired,onClick:dt.func,icon:dt.node};const w1=x.section`
    position: relative;
    height: 730px;
    @media (max-width: 1301px) {
        width: 414px;
...
`,I1=()=>s.jsxs(w1,{children:[s.jsx(C1,{id:"sec1",src:"./home/new-year-event-fire.png"}),s.jsx(_1,{src:"./home/shadow-line1.svg"}),s.jsx(P1,{src:"./home/shadow-line2.svg"}),s.jsx(N1,{src:"./home/shadow-line-mobile.svg"}),s.jsxs(S1,{children:[s.jsx("img",{src:"./home/new-year-event-title.svg"}),s.jsx("img",{src:"./home/common-title-lottery.svg"})]}),s.jsxs(j1,{children:[s.jsx("span",{children:"2024/12/15-2025/1/20"}),"期間，",s.jsx("br",{}),"成功網路投保",s.jsx("span",{children:"「國外旅平險」"})]}),s.jsxs(T1,{children:["HAPPY",s.jsx("br",{}),"NEW YEAR",s.jsx("br",{}),"2025"]}),s.jsx($1,{src:"./home/new-year-event.svg"}),s.jsx(z1,{src:"./home/new-year-event-mobile.svg"}),s.jsx(L1,{children:s.jsx(Ke,{color:"blue",height:"60px",children:"投保立即抽"})}),s.jsx(k1,{src:"./home/new-year-event-flower.svg"}),s.jsx(E1,{src:"./home/new-year-event-flower-mobile.svg"})]}),R1=x.section`
    position: relative;
    height: 1127px;
    @media (max-width: 1301px) {
        overflow: hidden;
...
`,J1=()=>s.jsxs(R1,{children:[s.jsx(O1,{src:"./home/reach-insure-amount-event-trapezoid.svg"}),s.jsx(F1,{src:"./home/reach-insure-amount-event-trapezoid-mobile.svg"}),s.jsx(A1,{id:"sec2",src:"./home/reach-insure-amount-event-temple.svg"}),s.jsx(B1,{src:"./home/reach-insure-amount-event-mountain.svg"}),s.jsxs(U1,{children:[s.jsx("img",{src:"./home/reach-insure-amount-event-title.svg"}),s.jsx("img",{src:"./home/common-title-lottery.svg"})]}),s.jsxs(W1,{children:["2024/10/1~2025/1/31期間，",s.jsx("br",{}),"成功網路投保",s.jsx("span",{children:"「國外旅平險」"}),"，單筆保費滿額即可抽！"]}),s.jsxs(H1,{children:["TRAVEL",s.jsx("br",{}),"JAPAN",s.jsx("br",{}),"TOKYO"]}),s.jsx(V1,{src:"./home/reach-insure-amount-event1.svg"}),s.jsx(X1,{src:"./home/reach-insure-amount-event1-mobile.svg"}),s.jsx(Q1,{children:s.jsx(Ke,{color:"blue",height:"60px",children:"投保立即抽"})}),s.jsx(Y1,{src:"./home/reach-insure-amount-event2.svg"}),s.jsx(K1,{src:"./home/reach-insure-amount-event2-mobile.svg"}),s.jsx(G1,{children:s.jsx(Ke,{color:"blue",height:"60px",children:"投保立即抽"})}),s.jsx(M1,{src:"./home/reach-insure-amount-event-flower.svg"}),s.jsx(D1,{src:"./home/reach-insure-amount-event-flower-mobile.svg"})]}),Z1=x.section`
    position: relative;
    height: 1429px;
    @media (max-width: 1301px) {
        height: 1529px;
...
`;function Sx(){return s.jsx(vx,{children:s.jsxs(yx,{children:[s.jsx(u1,{}),s.jsx(I1,{}),s.jsx(J1,{}),s.jsx(xx,{}),s.jsx(wx,{src:"./home/home-fly.svg"})]})})}const jx=x.div`
  padding-top: 90px;
  background-color: #FFFAF1;
  display: flex;
  justify-content: center;
...
`,Xx=()=>{const[e,t]=P.useState(!0);return P.useEffect(()=>{const n=setInterval(()=>{t(!e)},1e3);return()=>clearInterval(n)},[e]),s.jsx(jx,{children:s.jsxs(kx,{children:[s.jsxs(Vx,{children:[s.jsx(Ex,{src:"./mgm/mgm-trapezoid.svg"}),s.jsx(Cx,{src:"./mgm/mgm-banner-flower.svg"}),s.jsx(_x,{src:"./mgm/mgm-info-flower.svg"}),s.jsx(Px,{src:"./mgm/mgm-content-p-point.svg"}),s.jsx(Nx,{src:"./mgm/mgm-building.svg"}),s.jsx(Tx,{src:"./mgm/mgm-blue-building.svg"})]}),s.jsx($x,{src:"./mgm/mgm-banner-video-mobile.mp4",autoPlay:!0,muted:!0}),s.jsx(zx,{src:"./mgm/mgm-title.png"}),s.jsx(Lx,{src:"./mgm/mgm-title-p.png"}),s.jsxs(Ql,{isBlue:e,children:[s.jsx("p",{children:"推薦好友全球旅平險"}),s.jsxs("p",{children:["快樂",s.jsx("span",{children:"+1+1+1+1+1+1+1+1+1"})]})]}),s.jsxs(Ix,{children:["COLLECT",s.jsx(Rx,{reverse:!0})," A LOT OF LINE POINTS"]}),s.jsxs(Ox,{children:[s.jsx("p",{children:"2024/10/1~2025/1/31"}),s.jsx("p",{children:"成功邀請親友投保旅平險，達指定筆數"})]}),s.jsx(Fx,{src:"./mgm/mgm-line-points-text.svg"}),s.jsx(Mx,{}),s.jsx(Dx,{}),s.jsx(Ax,{}),s.jsx(Bx,{src:"./mgm/mgm-people-and-frame.svg"}),s.jsx(Ux,{children:s.jsx("p",{children:"只要親友點選「你的推薦連結」成功投保"})}),s.jsx(Wx,{src:"./mgm/mgm-bottom-info-title.svg"}),s.jsxs(Hx,{children:[s.jsx("p",{children:"點擊上方按鈕後，註冊或登入取得邀請碼"}),s.jsx("p",{children:"就能分享給親友，一起抽點數！"})]})]})})},Qx=x.div`
  ...
  flex-direction: column;
  gap: 10px;
`,Yx=()=>s.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",title:"減號圖標",children:s.jsx("path",{d:"M6 12L18 12",stroke:"#000000",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),Kx=()=>s.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",title:"加號圖標",children:s.jsx("path",{d:"M12 6V18M6 12H18",stroke:"#000000",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),Gx=x.div`
  width: ${e=>e.$width||"100%"};
  height: ${e=>e.$height||"65px"};
  background-color: #FFFAF1;
  border-radius: 8px;
...
`,fc=x.div`
  position: relative;
  right: 50px;
`;function zs({title:e,isOpen:t,onClick:n,children:r}){return s.jsxs(Qx,{children:[s.jsxs(Zx,{onClick:n,children:[s.jsx(Gx,{}),s.jsx(Jx,{children:s.jsx("div",{style:{zIndex:5},children:e})}),t?s.jsx(fc,{children:s.jsx(Yx,{})}):s.jsx(fc,{children:s.jsx(Kx,{})})]}),t&&r]})}zs.propTypes={title:dt.string.isRequired,isOpen:dt.bool.isRequired,onClick:dt.func.isRequired,children:dt.node.isRequired};const qx=x.ol`
  padding-left: 20px;
`,Ve=x.li`
  margin-bottom: 10px;
  list-style: decimal;
